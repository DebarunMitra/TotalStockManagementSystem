              ...
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                 ...
                 <div class="col-md-6">
                  ...
                  <?php
                //echo $_GET['slipno'];
                    $sd= mysqli_query($link, "SELECT rq_sl_no,gen_by,gen_by_desg FROM dept_inc_req WHERE slip_no=".$_GET['slipno']."");
                    ...
                    <div class="x_content">
                      ...
                      <table class="table table-striped jambo_table" id="req_table_list">
                        ...
                        <tbody>
                            ...
                            if($num_item>0)
                            {
                                $items= mysqli_query($link,"SELECT rq_sl_no,sc_name,mat_maker,mat_des,mat_qty,mat_unit,aer_app FROM dept_inc_req WHERE slip_no='".$_GET['slipno']."' AND aer_app=0 AND dir_app=0");
                                $count=1;
                      ...
                      <div class="x_content">
                          <div>
                              <center>
                                  <button type="button" class="btn btn-warning" id="stock_admin" name="stock_admin" >To Stock Admin</button>
                                  ...
                                  if($('#table_records_'+i).prop("checked")==true)
                                    {
                                        ...
                                        id=val[1];
                                        $('#load').show();
                                        $('#result').load('aer_approval.php?appstock='+id);
                                  ...
                                  if($('#table_records_'+i).prop("checked")==true)
                                    {
                                        ...
                                        id=val[1];
                                        $('#load').show();
                                        $('#result').load('aer_approval.php?acc_appdir='+id);
                                        $('#'+rowid).prop("checked",false);
                                        //alert(rowid);
                                        $('#'+rowid).remove();
                                        //$('#'+rowid).hide();

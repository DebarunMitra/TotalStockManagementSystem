            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
               <h3>
                ...
                <li><a href="aer_req_details.php"><i class="fa fa-edit"></i>Account requisitions</a></li>
                  <!--<li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                ...
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                   ...
                   // echo $_SESSION['smsdept_sec'];
                        $req="select * from dept_inc_req where gen_by_dept='".$_SESSION['smsdept_sec']."' AND gen_by_app=1  AND gen_date <= now()";
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <?php
                      ...
                      <li>
                          ...
                          <a href="acc_req_request.php?slipno=<?=$slip[$i]?>" class="btn-block">Check Slip no <?=$slip[$i]?></a>
                        <span class="message">

        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>Item Entry Search<small> stock entry search</small></h3>
                  </div>
            ...
            if(isset($_POST['search'])){
                $sql .= "SELECT * FROM item_entry_data where i_id>0 ";

      if ( $_POST['v_c_name'] !="" ){
           $sql .= " AND i_c_name = '" . $_POST['v_c_name']."'";
      }

      if ( $_POST['v_sc_name'] !="" ){
           $sql .= " AND i_sc_name = '" . $_POST['v_sc_name']."'";
      }
        ...
        <tbody>
            ...
            // if($num_item>0)
                           // {
                               ...
                               td><?=$count?></td-->
                                                 <td><?=$view_item['i_c_name']?></td>
                                                 <td><?=$view_item['i_sc_name']?></td>
                                                 <td><?=$view_item['fund']?></td>
                                                 <td><?=$view_item['i_maker']?> </td>
                                                 <td><?=$view_item['i_des']?></td>
                                                 <td><?=$view_item['i_model_no']?></td>
                                                 <td><?=$view_item['i_qty']?></td>
                                                 <td><?=$view_item['i_unit']?></td>
                                                 <td><?=$view_item['i_t_price']?></td>
                                                 <td><?=$view_item['i_e_date']?></td>
                                            </tr>
                                      <?php
                                  }
                              // }

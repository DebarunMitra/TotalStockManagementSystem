...
?>
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <?php
            //$_SESSION['dept_sr_no']='';
           // echo $_SESSION['dept_sr_no'];
            //print ($_SESSION);
                        $logtime=mysqli_query($link,"select in_time,out_time  from login_details where in_time IN (select max(in_time) from (SELECT * FROM `login_details`) AS l2) AND emp_id='".$_SESSION['smsemp_id']."'");
                  ...
                  <div class="x_content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dmat_des">Description
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="number" min="1" id="dmat_qty" name="dmat_qty" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                              <!--<div class="form-group">-->
                    ...
                    echo "<script type='text/javascript'>alert('$m');</script>";
                         ...
                         echo '<meta http-equiv="refresh" content="0; url=dept_requisition.php" />'; 
                       }  

...
?>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>Available Stock Search<small> available stock search</small></h3>
                  </div>
            ...
            if(isset($_POST['search'])){
                $sql .= "select sc.*, cm.c_name from subcategory_master as sc , category_master as cm where sc.sc_c_code=cm.c_code and stock>0";
   ...
   //   echo $sql;
            ...
            // if($num_item>0)
                           // {
                               ...
                               td><?=$count?></td-->
                                                 ...
                                                 <td><?=$view_item['sc_des']?></td>
                                                 <td><?=$view_item['stock']?></td>
                                            </tr>
                                      <?php
                                  }
                              // }
    ...
    //  include './viewentrytable.php';
             ...
             include './view_available_stock.php';
            }
            ?>
              </div>
            </div>

...
table.inventory td:nth-child(5) { text-align: center; width: 12%; }
		...
		<article>
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						<td width="8%">100</td>
						<td width="15%">Experience Review</td>
						<td width="50%">descriptionnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn</td>
						<td width="8%">100</td>
						<td width="8%">pppppppp</td>
					</tr>
				</tbody>
			</table>
		</article>
    ...
    <div class="box-footer">
            <center><input type="button" class="btn btn-info" onclick="return printDiv('print')" value="Print"> &nbsp;
                <a href="#" target="_blank" class="btn btn-success">Preview Raw File</a>

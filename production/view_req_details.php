...
Total Data On File 
                <?php 
            $q=  mysqli_query($link,"select rq_sl_no from user_requisition where gen_by='".$_SESSION['smsname']."'");
        ...
        <tbody>
            ...
            // if($num_item>0)
                           // {
                                $items= mysqli_query($link,"SELECT * FROM user_requisition where gen_by='".$_SESSION['smsname']."'");
                               // $count=1;
                                $s=1;

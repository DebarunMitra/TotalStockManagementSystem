<?php
    ...
    $item="SELECT * FROM user_requisition WHERE slip_no=".$_GET['rawslip']."";
...
table.inventory td:nth-child(5) { text-align: center; width: 12%; }
		...
		<article>
			...
			<table class="meta1">
				...
				<tbody> 
                                    <?php
                                    $item_2="SELECT * FROM user_requisition WHERE slip_no=".$_GET['rawslip']."";
					...
					<tr>
						...
						<td width="50%"><?=$items['mat_des']?></td>
						<td width="8%"><?=$items['dept_disp_qty']?></td>
    ...
    <div class="box-footer">
            <!--<center><input type="button" class="btn btn-info" onclick="return printDiv('print')" value="Print"> &nbsp;
                ...
                <center><input type="button" class="btn btn-danger" onclick="window.close()" value="Close"></center>
        </div>
        </div>
        <!-- /page content -->

...
?>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <form method="post">
                    ...
                    <table class="table">
                       <!-- <tr class="info">
                            <td>Employee Id
                                <input type="text" name="v_emp_id" class="form-control" list="namelist" tabindex="-1">
            ...
            if(isset($_POST['search'])){
                $sql .= "SELECT e.emp_id,u.* FROM emp_details AS e, user_requisition AS u WHERE e.emp_name=u.gen_by AND gen_by_dept='".$_SESSION['smsdept_sec']."'AND gen_by_app=1 ";
     /* if($_POST['v_emp_id']!=="")
      {
          $sql.="AND emp_id='".$_POST['v_emp_id']."'";
      }*/
      if ( $_POST['v_c_name'] !="" ){
                               ...
                               // $count=1;
                                ...
                                while($view_item = mysqli_fetch_array($items)) {
                                    ...
                                    <tr id="even" class="even pointer">
                                        ...
                                        <td><?= $s ?></td>
                                                <td><?=$view_item['slip_no']?></td>
                                              <!-- <td><?=$view_item['emp_id']?>-->
                                                 <td><?=$view_item['gen_by']?></td>
                                                 ...
                                                 <td><?=$view_item['hod_dept_date']?></td>
                                                 
                                                 <td><?=$view_item['dept_disp_date']?></td>
                                            </tr>
                                      <?php
                                      $s++;
                                  }
    ...
    //  include './viewentrytable.php';
             ...
             include './view_fac_req_details.php';
            }
            ?>
              </div>
            </div>
